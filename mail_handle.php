...
//session
$toName = $_SESSION['u_name'];
$toemail = $_SESSION['u_email'];
...
try {
    $mail->send();
     echo '<script>
        alert("User registered successfully! A verification email has been sent to your email address.");
        window.location.href="Auth/otp_verify.php";
        </script>';
} catch (Exception $e) {
