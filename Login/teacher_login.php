  ...
  <body>
    <div class="container" id="container">
      <div class="form-container sign-in">
        <form action="login_check.php?action=Teacher" method="POST">
          <h1>Sign In</h1>
          ...
          <a href="../Mail/Forgot_Password/forgot_password.php?action=Teacher">Forget Your Password?</a>
      ...
      <div class="toggle-container">
        <div class="toggle">
          <div class="toggle-panel toggle-right">
            <h3>Hello, Teacher! Welcome Back!</h3>
